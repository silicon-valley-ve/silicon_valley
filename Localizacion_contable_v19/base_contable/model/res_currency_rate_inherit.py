...
class CurrencyRate(models.Model):
    ...
    def create(self, vals):
        ...
        """
        # 1. Obtener la fecha de la nueva tasa.
        ...
        if rate_date_str:
            ...
            if rate_date < today:
                ...
                raise UserError(
                    ...
                    "No se permite crear tipos de cambio con fecha anterior a la fecha actual (%s). "
                )

        # 3. Si pasa la validación, llama al método original para crear el registro
