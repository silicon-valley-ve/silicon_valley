...
################################################################################
{
    ...
    'depends': ['point_of_sale', 'sale','bi_pos_igtf_workflow'],
    'data': [
        'views/res_config_settings_views.xml',
        'views/pos_payment_meth.xml',
        'views/buttom_menu_view.xml',
        'views/res_user_views.xml',
        'views/vista_pos_order_inherit.xml',
    ],
    'assets': {
        'point_of_sale._assets_pos': [
            'pos_receipt_extend/static/src/xml/OrderReceipt.xml',
            'pos_receipt_extend/static/src/xml/custom_order_receipt.xml',
            'pos_receipt_extend/static/src/js/PosOrder.js',
            'pos_receipt_extend/static/src/js/custom_butom.js',
        ]
    },
